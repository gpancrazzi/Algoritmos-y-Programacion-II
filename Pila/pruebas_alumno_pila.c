...
void pruebas_pila_creada() {
	...
	print_test("Prueba pila crear pila la pila existe", pila1);
    print_test("Prueba pila recien creada la pila esta vacia", pila_esta_vacia(pila1));
    print_test("Prueba pila recien creada ver tope es NULL", !pila_ver_tope(pila1));
    print_test("Prueba pila recien creada desapilar es NULL", !pila_desapilar(pila1));
    print_test("Prueba pila apilar un elemento es true", pila_apilar(pila1, val));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila1) == val);
    print_test("Prueba pila la pila no esta vacia", !pila_esta_vacia(pila1));
    pila_destruir(pila1);
...
void pruebas_pila_apilar_desapilar() {
	...
	print_test("Prueba pila apilar un elemento es true", pila_apilar(pila2, val[1]));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[1]);
	print_test("Prueba pila apilar un segundo elemento es true", pila_apilar(pila2, val[0]));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[0]);
    print_test("Prueba pila apilar un tercer elemento es true", pila_apilar(pila2, val[2]));
    ...
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[0]);
    print_test("Prueba pila apilar un tercer elemento es true", pila_apilar(pila2, val[6]));
	print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[6]);
    print_test("Prueba pila apilar un cuarto elemento es true", pila_apilar(pila2, val[3]));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[3]);
    print_test("Prueba pila apilar un quinto elemento es true", pila_apilar(pila2, val[4]));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[4]);
    print_test("Prueba pila apilar sexto elemento (valor negativo) es true", pila_apilar(pila2, val[5]));
    print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[5]);
    print_test("Prueba pila apilar un septimo elemento (valor NULL) es true", pila_apilar(pila2, NULL));
    print_test("Prueba pila el tope de la pila es el correcto", !pila_ver_tope(pila2));
    print_test("Prueba pila desapilar devuelve el valor correcto", !pila_desapilar(pila2));
	print_test("Prueba pila el tope de la pila es el correcto", pila_ver_tope(pila2) == val[5]);
	...
	print_test("Prueba pila el tope de la pila es el correcto", !pila_ver_tope(pila2));
    print_test("Prueba pila desapilar devuelve el valor correcto", !pila_desapilar(pila2));
    print_test("Prueba pila la pila esta vacia", pila_esta_vacia(pila2));
...
void pruebas_pila_volumen() {
	...
	print_test("Prueba pila el tope de la pila es NULL", !pila_ver_tope(pila3));
    print_test("Prueba pila desapilar es NULL", !pila_desapilar(pila3));
    print_test("Prueba pila la pila esta vacia", pila_esta_vacia(pila3));
	pila_destruir(pila3);
    print_test("Prueba pila la pila fue destruida", true);
}
