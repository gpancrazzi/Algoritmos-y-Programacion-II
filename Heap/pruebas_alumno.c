...
static void prueba_heap_encolar_algunos_elementos() {
    ...
    print_test("Prueba heap la cantidad de elementos es 0", heap_cantidad(heap) == 0);
    print_test("Prueba heap obtener maximo es NULL", !heap_ver_max(heap));
    print_test("Prueba heap esta vacio es true", heap_esta_vacio(heap));
    print_test("Prueba heap desencolar es NULL", !heap_desencolar(heap));
...
static void prueba_heap_destruir() {
    ...
    print_test("Prueba heap encolar clave1 de memoria dinamica", heap_encolar(heap, clave1));
    print_test("Prueba heap encolar clave2 de memoria dinamica", heap_encolar(heap, clave2));
    print_test("Prueba heap encolar clave3 de memoria dinamica", heap_encolar(heap, clave3));
    print_test("Prueba heap encolar clave4 de memoria dinamica", heap_encolar(heap, clave4));
    print_test("Prueba heap encolar clave5 de memoria dinamica", heap_encolar(heap, clave5));
